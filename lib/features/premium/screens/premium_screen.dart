...
class _PremiumScreenState extends ConsumerState<PremiumScreen> with TickerProviderStateMixin {
          ...
          children: List.generate(marketingSlides.length, (index) {
            ...
            return Padding(
              ...
              child: AnimatedContainer(
                ...
                width: 6.0 * scale.clamp(0.7, 1.0),
                height: 6.0 * scale.clamp(0.7, 1.0),
                decoration: BoxDecoration(
  ...
  Widget _buildPurchaseOptions(BuildContext context, WidgetRef ref, Offerings? offerings) {
    ...
    // Eğer hiç seçim yapılmadıysa, yıllık planı varsayılan olarak seç
            ...
            if (yearly != null)
              _PurchaseOptionCard(
                ...
                onTap: () {
                  ...
                  _purchasePackage(context, ref, yearly!);
                },
              ),
            ...
            if (monthly != null)
              _PurchaseOptionCard(
                ...
                onTap: () {
                  ...
                  _purchasePackage(context, ref, monthly!);
                },
              ),
          ],
        ),
...
class _PriceTransparencyFooter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final textStyle = theme.textTheme.bodySmall?.copyWith(color: textColor, height: 1.3, fontSize: 10);
            ...
            child: ShaderMask(
              shaderCallback: (bounds) => LinearGradient(
                colors: [
                  ...
                  Color.lerp(colorScheme.onSurface, colorScheme.tertiary, 0.3)!,
                ],
              ).createShader(bounds),
              child: Text(
                'TaktikAI Premium',
      ...
      decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: isDark
                ? [
                    colorScheme.surface,
                    Color.lerp(colorScheme.surface, color, 0.03)!,
                  ]
                : [
                    colorScheme.surface,
                    Color.lerp(colorScheme.surface, color, 0.05)!,
                  ],
          ),
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: widget.highlight
                    ...
                    : null,
                color: widget.highlight ? null : backgroundColor,
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                  color: borderColor,
                  width: widget.highlight ? 2.5 : 1.5,
                ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (hasFreeTrial && !widget.highlight)
                          ...
                          const SizedBox(height: 4), // Eğer deneme yoksa boşluk ekle
                            ...
                            gradient: widget.highlight
                                ? LinearGradient(
                                    ...
                                    colors: [
                                      ...
                                      Color.lerp(colorScheme.secondary, colorScheme.tertiary, 0.3)!,
                                    ],
                                  )
                                : LinearGradient(
                                    begin: Alignment.topLeft,
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const SizedBox(width: 8),
              Text('|', style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.38), fontSize: 10)),
              const SizedBox(width: 8),
