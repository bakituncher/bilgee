...
class _ProfileView extends ConsumerWidget {
  ...
  List<app_badge.Badge> _generateBadges(BuildContext context, UserModel user, PerformanceSummary performance, PlanDocument? planDoc, int testCount, double avgNet, List<FocusSessionModel> focusSessions, int streak) {
    ...
    return [
      ...
      app_badge.Badge(name: 'İlk Etüt', description: 'Etüt Odası\'nda ilk konunu çalıştın.', icon: Icons.construction, color: colorScheme.primary, isUnlocked: performance.topicPerformances.isNotEmpty, hint: "Etüt Odası'nı kullan."),
