...
class PremiumHeroCard extends StatelessWidget {
                        ...
                        children: [
                          Expanded(
                            child: PremiumStatItem(
                              ...
                              label: 'Deneme',
                              value: '${user.testCount}', // DEĞİŞTİRİLDİ: tests.length yerine user.testCount
                          ...
                          Expanded(
                            child: PremiumStatItem(
                              ...
                              label: 'Puan',
                              value: '${user.engagementScore}', // Null-safety zaten modelde var
  ...
  String _getMotivationMessage() {
    ...
    if (user.testCount >= 20) return 'Süper çalışkansın! 📚'; // DEĞİŞTİRİLDİ: tests.length yerine user.testCount
    if (user.testCount >= 10) return 'İyi ilerliyorsun! 🎯'; // DEĞİŞTİRİLDİ: tests.length yerine user.testCount
  ...
  Color _getMotivationColor() {
    ...
    if (user.testCount >= 20) return const Color(0xFF8B5CF6); // DEĞİŞTİRİLDİ
    if (user.testCount >= 10) return const Color(0xFF10B981); // DEĞİŞTİRİLDİ
  ...
  IconData _getMotivationIcon() {
    ...
    if (user.testCount >= 20) return Icons.military_tech_rounded; // DEĞİŞTİRİLDİ
    if (user.testCount >= 10) return Icons.trending_up_rounded; // DEĞİŞTİRİLDİ
  ...
  IconData _getStatusIcon() {
    ...
    if (user.testCount >= 10) return Icons.star_rounded; // DEĞİŞTİRİLDİ
  ...
  String _getStatusText() {
    ...
    if (user.testCount >= 10) return 'AKTİF'; // DEĞİŞTİRİLDİ
    return 'YENİ';
  }
